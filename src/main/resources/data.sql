INSERT INTO foodstuff (name, price,quantity_for_deliver,deliver_state,on_kitchen_state,unit) VALUES
  ('Капуста', 80.50,1.0,'DOESNT_NEED_TO_BE_PURCHASED','INNESSCESSARY','KG'),
